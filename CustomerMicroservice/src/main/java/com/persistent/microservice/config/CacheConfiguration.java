package com.persistent.microservice.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("CustomerMicroservice");
        ...
        config.setInstanceName("CustomerMicroservice");
        ...
        config.getMapConfigs().put("com.persistent.microservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
