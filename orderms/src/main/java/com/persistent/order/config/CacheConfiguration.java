package com.persistent.order.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("orderms");
        ...
        config.setInstanceName("orderms");
        ...
        config.getMapConfigs().put("com.persistent.order.domain.*", initializeDomainMapConfig(jHipsterProperties));
